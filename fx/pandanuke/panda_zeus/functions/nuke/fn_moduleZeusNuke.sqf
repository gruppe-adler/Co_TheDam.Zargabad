...
if (_activated) then {
	...
	nukemarker setMarkerTextLocal "ZEUS NUKE";
...
deletevehicle _light;
	...
	[_pad,_kT] spawn panda_fnc_schockwelle;

[panda_objectx] spawn panda_fnc_basicnuke; 

if (_fC) then
	{
	[_pad,_kT,windAngle,true] spawn panda_fnc_falloutcloud;
	};
sleep 10;
...
deletevehicle _logic;
	...
	uinamespace setvariable ["bis_fnc_moduleZeusNuke_created",true];
	};
};