...
_light1 setLightIntensity 1600;
...
_lightg1 setLightIntensity 600;
...
for "_cnt" from 0 to 5000 do
{
  ...
  _light1 setLightIntensity (1600 * _scl);
  _light1 setpos [_xpos, _ypos, _zpos];
  _lightg1 setLightIntensity (600 * _sclg);
...
// setLightIntensity 3000; = setLightBrightness 6;