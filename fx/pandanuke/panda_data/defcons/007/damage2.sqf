...
{
  [_xpos, _ypos, _dis] exec "\panda_syndicate\panda_data\defcons\007\wave.sqs";
  if ( ! schaden_an ) then
  {
    if ( _dis < 800 ) then {[_xpos, _ypos, _dis] execvm "\panda_syndicate\panda_data\defcons\007\noise.sqf"};
  };
  {
  ...
  [_xpos, _ypos, time] execvm "\panda_syndicate\panda_data\defcons\007\geiger.sqf";
  [_xpos, _ypos, time] execvm "\panda_syndicate\panda_data\defcons\007\radiation.sqf";
